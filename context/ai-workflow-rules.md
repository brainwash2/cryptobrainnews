...
how to build it, and what the current state of progress is. Always implement against these specs —
...
- UI changes and pipeline/background task changes
- Real-time data rendering and database persistence
...
Do not modify generated or shared foundation components unless explicitly instructed:

- `src/components/ui/*` — base primitives
- Third-party library internals

Project-specific styling, layout changes, and feature logic must be implemented in app-level
...
- System architecture or storage model decisions
- Code conventions or standards
- Feature scope or invariants
