...
export const post = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description: 'Topic tags e.g. "rwa-tokenization", "blackrock-buidl", "on-chain-treasuries". Lowercase, hyphenated.',
      of: [{ type: 'string' }],
      options: { layout: 'tags' },
    }),
    defineField({
    ...
    defineField({
      ...
      description: 'Optional: schedule future publication (requires Growth plan or manual cron).',
    }),
    defineField({
