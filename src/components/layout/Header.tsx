...
export default function Header() {
  ...
  return (
    <header className="bg-black border-b border-[#222] sticky top-0 z-50">
        ...
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden lg:flex items-center gap-6">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {newsDropdownOpen && (
                <div className="absolute top-full left-0 mt-2 w-52 bg-[#0a0a0a] border border-[#222] shadow-2xl z-50">
                  {/* All news link */}
                  <Link
                    href="/news"
                    onClick={() => setNewsDropdownOpen(false)}
                    className="block px-4 py-3 text-[10px] font-black uppercase tracking-widest text-[#FABF2C] hover:bg-[#111] border-b border-[#1a1a1a] transition-colors"
                  >
                    All News
                  </Link>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="lg:hidden absolute top-16 left-0 w-full bg-[#0a0a0a] border-b border-[#222] p-4 flex flex-col gap-4 shadow-2xl max-h-[80vh] overflow-y-auto">
          ...
          >
            ...
            />
            <button type="submit" className="bg-[#FABF2C] text-black px-4 py-2 text-[10px] font-black uppercase">
              Go
            </button>
          </form>
          ...
          {/* Mobile NEWS section */}
          <div>
            <p className="text-[10px] font-black uppercase tracking-widest text-[#FABF2C] pb-2 border-b border-[#1a1a1a] mb-2">
              News
            </p>
            <Link
              href="/news"
